...
if ($culinary!="") {
	$querysearch	.=", culinary_place.id as id2, culinary_place.name as name2, st_x(st_centroid(culinary_place.geom)) as lon2, st_y(st_centroid(culinary_place.geom)) as lat2";
}
